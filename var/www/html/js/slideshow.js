jQuery.fn.slider = function(aj) {
    ...
    aj = aF.extend({
        ...
        autoPlayVideo: false,
        responsive: 1,
        support: jQuery.fn.slider.support,
        stopOnHover: 0,
        preventCopy: 1
    }, aj);
    ...
    var b = aj.images && (new sliderPreloader(this, aj));
    var aL = aq.find("li");
    var z = aL.length;
    ...
    if (typeof sliderVideo == "function") {
        var F = aF('<div class="ws_video_btn"><div></div></div>').appendTo(aq);
        ap = new sliderVideo(H, aj, n);
...
jQuery("#slider-container1").slider({
    effect: "basic_linear",
    prev: "",
    next: "",
    duration: 1750,
